...
@injectable()
export class ComplexTokenService implements ITokenService<ComplexToken, ComplexTokenCreateDTO> {
    ...
    constructor(
        ...
        @inject(TOKEN_TYPES.ComplexTokenPersistenceStrategy) tokenPersistenceStrategy: ITokenPersistenceStrategy<ComplexToken>,
        @inject(TOKEN_TYPES.ComplexTokenRepository) tokenRepository: IComplexTokenRepository
    ) {
