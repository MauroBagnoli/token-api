...
import { IBasicTokenRepository } from "../core/tokens/basic-token/types";
...
import { ComplexTokenResponseDto } from "../core/tokens/basic-token/models/dto/response/token-response.dto";
import { ComplexTokenRepository } from "../core/tokens/complex-token/complex-token.repository";
import { BasicTokenController } from "../api/controllers/tokens/basic-token.controller";
...
// Service Bindings
container.bind<ITokenService<BasicToken, BasicTokenCreateDTO>>(TOKEN_TYPES.BasicTokenService).to(BasicTokenService).inSingletonScope();
container.bind<ITokenService<ComplexToken, ComplexTokenResponseDto>>(TOKEN_TYPES.ComplexTokenService).to(ComplexTokenService).inSingletonScope();
